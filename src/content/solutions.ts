...
export const solutions: Record<string, Solution> = {
  'dental-practices': {
    ...
    description:
      'Attract more patients and grow your dental practice with our comprehensive marketing solutions designed specifically for general dentistry.',
    benefits: [
  ...
  'orthodontic-practices': {
    ...
    description:
      'Stand out in your market and attract more orthodontic patients with marketing strategies designed for orthodontists.',
    benefits: [
  ...
  'cosmetic-dentistry-practices': {
    ...
    description:
      'Position your practice as the premier destination for cosmetic dentistry with marketing that showcases your transformative work.',
    benefits: [
  ...
  'chiropractic-practices': {
    ...
    description:
      'Grow your chiropractic practice with marketing strategies that position you as the go-to wellness provider in your community.',
    benefits: [
  ...
  'dermatology-practices': {
    ...
    description:
      'Attract more patients seeking medical and cosmetic dermatology services with marketing built for dermatologists.',
    benefits: [
  ...
  'optometry-practices': {
    ...
    description:
      'Stand out from retail chains and grow your optometry practice with marketing that highlights your personalized care.',
    benefits: [
  ...
  'plastic-surgery-practices': {
    ...
    description:
      'Attract more consultations and grow your plastic surgery practice with premium marketing and branding.',
    benefits: [
  ...
  'dso-marketing-agency': {
    ...
    description:
      'Scale your DSO with marketing solutions designed for multi-location dental organizations.',
    benefits: [
