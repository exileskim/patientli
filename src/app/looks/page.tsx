  ...
  return (
    <div className="group">
      ...
      <Link href={`/looks/${look.slug}`}>
        <h3 className="text-xl font-heading mb-2 group-hover:text-[var(--color-accent-dark)] transition-colors">
          {look.title}
        </h3>
      </Link>
      ...
      <div className="flex gap-3">
        <Link
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-full border-2 border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-bg-cream)] transition-colors"
        >
        ...
        <button
          className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-full bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-dark)] transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
