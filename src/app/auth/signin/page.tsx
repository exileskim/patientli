          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--color-text-secondary)]">
                Sign in to your Patientli account
              </p>
            </div>
            ...
            <div className="bg-[var(--color-bg-cream)] rounded-3xl p-8">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border border-[var(--color-border)] rounded-full hover:bg-gray-50 transition-colors mb-6"
              >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[var(--color-bg-cream)] text-[var(--color-text-muted)]">
